...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'This app provides simulated X-ray visuals for entertainment only.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Accept Disclaimer & Privacy Policy'**
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['bn', 'en', 'es', 'hi', 'mr', 'ta', 'te'].contains(locale.languageCode);
